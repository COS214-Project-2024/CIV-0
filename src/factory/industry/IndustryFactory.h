...
public:
    ...
    /**
     * @brief Creates a medium industrial entity of the specified type at the given position.
     * 
     * @param type The type of industrial entity to create.
     * @param xPos The x-coordinate of the entity's position.
     * @param yPos The y-coordinate of the entity's position.
    ...
    /**
     * @brief Creates a large industrial entity of the specified type at the given position.
     * 
     * @param type The type of industrial entity to create.
     * @param xPos The x-coordinate of the entity's position.
     * @param yPos The y-coordinate of the entity's position.
