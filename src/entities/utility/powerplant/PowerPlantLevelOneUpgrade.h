...
public:
     ...
     * 
     * Returns the power output of the level one upgraded power plant, which reflects a 1.5x enhancement.
     * 
...
private:
    const int UPGRADE = 1.5; ///< Multiplier applied to the original power output for the level one upgrade.
};
