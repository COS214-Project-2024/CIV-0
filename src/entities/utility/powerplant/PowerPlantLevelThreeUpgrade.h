...
public:
     ...
     * 
     * Returns the power output of the level three upgraded power plant, reflecting a 5.25x enhancement.
     * 
...
private:
    const int UPGRADE = 5.25; ///< Multiplier applied to the original power output for the level three upgrade.
};
