...
public:
     ...
     * 
     * Returns the sewage system output after the level two upgrade, reflecting a 2.625x enhancement.
     * 
...
private:
    const int UPGRADE = 2.625; ///< Multiplier applied to the original output for the level two upgrade.
};
