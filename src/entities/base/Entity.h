...
public:
    ...
    /**
     * @brief Gets the entity type of this entity.
     *
    ...
    /**
     * @brief Gets the symbol of the entity.
     *
    ...
    /**
     * @brief Gets the electricity consumption of the entity.
     *
     * @return Electricity consumption value.
     */
    float getElectricityConsumption();

    /**
     * @brief Gets the water consumption of the entity.
     *
     * @return Water consumption value.
     */
