...
private:
    ...
    void initializeEntityConfig()
    {
        ...
        entityConfigTable.emplace(std::make_pair(EntityType::HOUSE, Size::LARGE),
                                  EntityConfig(Cost(300, 120, 50, 30), 7, 3, "H", 7, 15, 3, 4, 4, 1500, 3, EntityType::HOUSE, Size::LARGE));
        ...
        entityConfigTable.emplace(std::make_pair(EntityType::FACTORY, Size::SMALL),
                                  EntityConfig(Cost(500, 200, 100, 50), 20, 10, "F", 10, -5, -10, 4, 4, 3000, 3, EntityType::FACTORY, Size::SMALL));
        entityConfigTable.emplace(std::make_pair(EntityType::FACTORY, Size::MEDIUM),
                                  EntityConfig(Cost(700, 300, 150, 80), 30, 15, "F", 15, -10, -15, 6, 6, 5000, 3, EntityType::FACTORY, Size::MEDIUM));
        entityConfigTable.emplace(std::make_pair(EntityType::FACTORY, Size::LARGE),
                                  EntityConfig(Cost(1000, 400, 200, 100), 50, 20, "F", 20, -20, -25, 8, 8, 10000, 3, EntityType::FACTORY, Size::LARGE));

        // Offices
        entityConfigTable.emplace(std::make_pair(EntityType::OFFICE, Size::SMALL),
                                  EntityConfig(Cost(400, 100, 60, 20), 10, 4, "O", 5, 5, 2, 3, 3, 2000, 3, EntityType::OFFICE, Size::SMALL));
        entityConfigTable.emplace(std::make_pair(EntityType::OFFICE, Size::MEDIUM),
                                  EntityConfig(Cost(600, 150, 90, 30), 20, 8, "O", 7, 10, 4, 4, 4, 4000, 3, EntityType::OFFICE, Size::MEDIUM));
        entityConfigTable.emplace(std::make_pair(EntityType::OFFICE, Size::LARGE),
                                  EntityConfig(Cost(900, 250, 120, 40), 30, 12, "O", 10, 15, 6, 5, 5, 6000, 3, EntityType::OFFICE, Size::LARGE));

        // Shopping Malls
        entityConfigTable.emplace(std::make_pair(EntityType::SHOPPINGMALL, Size::SMALL),
                                  EntityConfig(Cost(800, 300, 150, 100), 40, 25, "M", 8, 15, 10, 5, 5, 8000, 3, EntityType::SHOPPINGMALL, Size::SMALL));
        entityConfigTable.emplace(std::make_pair(EntityType::SHOPPINGMALL, Size::MEDIUM),
                                  EntityConfig(Cost(1500, 500, 300, 200), 60, 35, "M", 12, 20, 15, 8, 8, 15000, 3, EntityType::SHOPPINGMALL, Size::MEDIUM));
        entityConfigTable.emplace(std::make_pair(EntityType::SHOPPINGMALL, Size::LARGE),
                                  EntityConfig(Cost(3000, 1000, 500, 400), 100, 50, "M", 15, 30, 20, 10, 10, 30000, 3, EntityType::SHOPPINGMALL, Size::LARGE));

        // Schools
        entityConfigTable.emplace(std::make_pair(EntityType::SCHOOL, Size::SMALL),
                                  EntityConfig(Cost(600, 200, 80, 50), 10, 5, "S", 6, 8, 4, 4, 4, 2500, 3, EntityType::SCHOOL, Size::SMALL));
        entityConfigTable.emplace(std::make_pair(EntityType::SCHOOL, Size::MEDIUM),
                                  EntityConfig(Cost(1200, 400, 160, 100), 20, 10, "S", 10, 12, 6, 6, 6, 5000, 3, EntityType::SCHOOL, Size::MEDIUM));
        entityConfigTable.emplace(std::make_pair(EntityType::SCHOOL, Size::LARGE),
                                  EntityConfig(Cost(1800, 600, 240, 150), 30, 15, "S", 15, 18, 8, 8, 8, 7500, 3, EntityType::SCHOOL, Size::LARGE));

        // Hospitals
        entityConfigTable.emplace(std::make_pair(EntityType::HOSPITAL, Size::SMALL),
                                  EntityConfig(Cost(1000, 400, 200, 150), 25, 10, "H", 8, 10, 6, 6, 6, 10000, 3, EntityType::HOSPITAL, Size::SMALL));
        entityConfigTable.emplace(std::make_pair(EntityType::HOSPITAL, Size::MEDIUM),
                                  EntityConfig(Cost(2000, 600, 300, 200), 35, 15, "H", 12, 15, 10, 8, 8, 15000, 3, EntityType::HOSPITAL, Size::MEDIUM));
        entityConfigTable.emplace(std::make_pair(EntityType::HOSPITAL, Size::LARGE),
                                  EntityConfig(Cost(4000, 1000, 500, 300), 50, 20, "H", 20, 25, 15, 10, 10, 30000, 3, EntityType::HOSPITAL, Size::LARGE));

        // Police Stations
        entityConfigTable.emplace(std::make_pair(EntityType::POLICESTATION, Size::SMALL),
                                  EntityConfig(Cost(700, 250, 120, 70), 8, 5, "P", 6, 10, 4, 4, 4, 4000, 3, EntityType::POLICESTATION, Size::SMALL));
        entityConfigTable.emplace(std::make_pair(EntityType::POLICESTATION, Size::MEDIUM),
                                  EntityConfig(Cost(1200, 400, 200, 100), 12, 7, "P", 10, 15, 6, 6, 6, 6000, 3, EntityType::POLICESTATION, Size::MEDIUM));
        entityConfigTable.emplace(std::make_pair(EntityType::POLICESTATION, Size::LARGE),
                                  EntityConfig(Cost(2000, 600, 300, 150), 18, 10, "P", 15, 20, 8, 8, 8, 10000, 3, EntityType::POLICESTATION, Size::LARGE));

        // Parks
        entityConfigTable.emplace(std::make_pair(EntityType::PARK, Size::SMALL),
                                  EntityConfig(Cost(300, 100, 50, 25), 0, 0, "P", 3, 12, 8, 4, 4, 0, 2, EntityType::PARK, Size::SMALL));
        entityConfigTable.emplace(std::make_pair(EntityType::PARK, Size::MEDIUM),
                                  EntityConfig(Cost(600, 200, 100, 50), 0, 0, "P", 6, 18, 10, 6, 6, 0, 2, EntityType::PARK, Size::MEDIUM));
        entityConfigTable.emplace(std::make_pair(EntityType::PARK, Size::LARGE),
                                  EntityConfig(Cost(1200, 400, 200, 100), 0, 0, "P", 10, 25, 15, 8, 8, 0, 2, EntityType::PARK, Size::LARGE));

        // Monuments
        entityConfigTable.emplace(std::make_pair(EntityType::MONUMENT, Size::SMALL),
                                  EntityConfig(Cost(2000, 700, 400, 300), 0, 0, "M", 12, 25, 18, 5, 5, 0, 5, EntityType::MONUMENT, Size::SMALL));
        entityConfigTable.emplace(std::make_pair(EntityType::MONUMENT, Size::MEDIUM),
                                  EntityConfig(Cost(3500, 1000, 600, 400), 0, 0, "M", 18, 30, 22, 7, 7, 0, 5, EntityType::MONUMENT, Size::MEDIUM));
        entityConfigTable.emplace(std::make_pair(EntityType::MONUMENT, Size::LARGE),
                                  EntityConfig(Cost(6000, 1500, 900, 600), 0, 0, "M", 25, 35, 28, 10, 10, 0, 5, EntityType::MONUMENT, Size::LARGE));

        // Theater
        entityConfigTable.emplace(std::make_pair(EntityType::THEATER, Size::SMALL),
                                  EntityConfig(Cost(1200, 400, 200, 150), 20, 10, "T", 8, 12, 10, 6, 6, 5000, 3, EntityType::THEATER, Size::SMALL));
        entityConfigTable.emplace(std::make_pair(EntityType::THEATER, Size::MEDIUM),
                                  EntityConfig(Cost(2500, 800, 500, 300), 30, 15, "T", 12, 20, 15, 8, 8, 10000, 3, EntityType::THEATER, Size::MEDIUM));
        entityConfigTable.emplace(std::make_pair(EntityType::THEATER, Size::LARGE),
                                  EntityConfig(Cost(4500, 1200, 700, 500), 45, 25, "T", 18, 30, 20, 10, 10, 15000, 3, EntityType::THEATER, Size::LARGE));

        // Power Plants
        entityConfigTable.emplace(std::make_pair(EntityType::POWERPLANT, Size::SMALL),
                                  EntityConfig(Cost(3000, 1200, 700, 500), 200, 0, "P", 15, -10, -15, 6, 6, 0, 6, EntityType::POWERPLANT, Size::SMALL));
        entityConfigTable.emplace(std::make_pair(EntityType::POWERPLANT, Size::MEDIUM),
                                  EntityConfig(Cost(5500, 2000, 1200, 800), 400, 0, "P", 20, -20, -30, 8, 8, 0, 8, EntityType::POWERPLANT, Size::MEDIUM));
        entityConfigTable.emplace(std::make_pair(EntityType::POWERPLANT, Size::LARGE),
                                  EntityConfig(Cost(8000, 3000, 2000, 1200), 600, 0, "P", 30, -30, -45, 10, 10, 0, 10, EntityType::POWERPLANT, Size::LARGE));

        // Water Supply Systems
        entityConfigTable.emplace(std::make_pair(EntityType::WATERSUPPLY, Size::SMALL),
                                  EntityConfig(Cost(2000, 900, 400, 250), 0, 50, "W", 10, 8, 5, 5, 5, 0, 4, EntityType::WATERSUPPLY, Size::SMALL));
        entityConfigTable.emplace(std::make_pair(EntityType::WATERSUPPLY, Size::MEDIUM),
                                  EntityConfig(Cost(3500, 1200, 600, 400), 0, 100, "W", 15, 15, 10, 7, 7, 0, 6, EntityType::WATERSUPPLY, Size::MEDIUM));
        entityConfigTable.emplace(std::make_pair(EntityType::WATERSUPPLY, Size::LARGE),
                                  EntityConfig(Cost(5000, 2000, 1000, 700), 0, 200, "W", 20, 25, 15, 10, 10, 0, 8, EntityType::WATERSUPPLY, Size::LARGE));

        // Waste Management
        entityConfigTable.emplace(std::make_pair(EntityType::WASTEMANAGMENT, Size::SMALL),
                                  EntityConfig(Cost(1000, 500, 300, 150), 10, 5, "W", 5, -5, -5, 5, 5, 0, 3, EntityType::WASTEMANAGMENT, Size::SMALL));
        entityConfigTable.emplace(std::make_pair(EntityType::WASTEMANAGMENT, Size::MEDIUM),
                                  EntityConfig(Cost(2000, 900, 500, 300), 15, 10, "W", 8, -10, -10, 7, 7, 0, 5, EntityType::WASTEMANAGMENT, Size::MEDIUM));
        entityConfigTable.emplace(std::make_pair(EntityType::WASTEMANAGMENT, Size::LARGE),
                                  EntityConfig(Cost(3500, 1500, 800, 600), 25, 15, "W", 12, -15, -15, 9, 9, 0, 7, EntityType::WASTEMANAGMENT, Size::LARGE));

        // Sewage Systems
        entityConfigTable.emplace(std::make_pair(EntityType::SEWAGESYSTEM, Size::SMALL),
                                  EntityConfig(Cost(1500, 700, 400, 250), 5, 10, "S", 6, -6, -8, 5, 5, 0, 4, EntityType::SEWAGESYSTEM, Size::SMALL));
        entityConfigTable.emplace(std::make_pair(EntityType::SEWAGESYSTEM, Size::MEDIUM),
                                  EntityConfig(Cost(2500, 1100, 600, 400), 10, 15, "S", 8, -10, -12, 7, 7, 0, 6, EntityType::SEWAGESYSTEM, Size::MEDIUM));
        entityConfigTable.emplace(std::make_pair(EntityType::SEWAGESYSTEM, Size::LARGE),
                                  EntityConfig(Cost(4000, 1500, 1000, 800), 20, 25, "S", 12, -15, -20, 10, 10, 0, 8, EntityType::SEWAGESYSTEM, Size::LARGE));

        // Stone Producer
        entityConfigTable.emplace(std::make_pair(EntityType::STONEPRODUCER, Size::SMALL),
                                  EntityConfig(Cost(1200, 600, 300, 200), 15, 0, "S", 6, 8, 5, 4, 4, 200, 3, EntityType::STONEPRODUCER, Size::SMALL));
        entityConfigTable.emplace(std::make_pair(EntityType::STONEPRODUCER, Size::MEDIUM),
                                  EntityConfig(Cost(2000, 1000, 500, 400), 30, 0, "S", 10, 15, 10, 6, 6, 400, 3, EntityType::STONEPRODUCER, Size::MEDIUM));
        entityConfigTable.emplace(std::make_pair(EntityType::STONEPRODUCER, Size::LARGE),
                                  EntityConfig(Cost(3500, 1500, 800, 600), 50, 0, "S", 15, 25, 20, 8, 8, 700, 3, EntityType::STONEPRODUCER, Size::LARGE));
        ...
        entityConfigTable.emplace(std::make_pair(EntityType::CONCRETEPRODUCER, Size::SMALL),
                                  EntityConfig(Cost(1400, 700, 350, 200), 20, 5, "C", 6, 10, 5, 4, 4, 250, 4, EntityType::CONCRETEPRODUCER, Size::SMALL));
        entityConfigTable.emplace(std::make_pair(EntityType::CONCRETEPRODUCER, Size::MEDIUM),
                                  EntityConfig(Cost(2500, 1200, 600, 400), 35, 10, "C", 9, 18, 10, 6, 6, 600, 4, EntityType::CONCRETEPRODUCER, Size::MEDIUM));
        entityConfigTable.emplace(std::make_pair(EntityType::CONCRETEPRODUCER, Size::LARGE),
                                  EntityConfig(Cost(4000, 2000, 1000, 700), 60, 15, "C", 12, 25, 15, 8, 8, 1000, 4, EntityType::CONCRETEPRODUCER, Size::LARGE));
        ...
        entityConfigTable.emplace(std::make_pair(EntityType::AIRPORT, Size::SMALL),
                                  EntityConfig(Cost(10000, 4000, 2000, 1000), 100, 50, "A", 20, -15, -10, 10, 10, 0, 10, EntityType::AIRPORT, Size::SMALL));
        entityConfigTable.emplace(std::make_pair(EntityType::AIRPORT, Size::MEDIUM),
                                  EntityConfig(Cost(15000, 6000, 3000, 1500), 200, 100, "A", 30, -20, -15, 12, 12, 0, 15, EntityType::AIRPORT, Size::MEDIUM));
        entityConfigTable.emplace(std::make_pair(EntityType::AIRPORT, Size::LARGE),
                                  EntityConfig(Cost(25000, 10000, 5000, 3000), 400, 150, "A", 40, -30, -20, 15, 15, 0, 20, EntityType::AIRPORT, Size::LARGE));

        // BusStop
        entityConfigTable.emplace(std::make_pair(EntityType::BUSSTOP, Size::SMALL),
                                  EntityConfig(Cost(100, 20, 10, 5), 0, 0, "B", 3, 5, 3, 2, 2, 0, 1, EntityType::BUSSTOP, Size::SMALL));
        entityConfigTable.emplace(std::make_pair(EntityType::BUSSTOP, Size::MEDIUM),
                                  EntityConfig(Cost(200, 40, 20, 10), 0, 0, "B", 4, 8, 5, 3, 3, 0, 1, EntityType::BUSSTOP, Size::MEDIUM));
        entityConfigTable.emplace(std::make_pair(EntityType::BUSSTOP, Size::LARGE),
                                  EntityConfig(Cost(500, 100, 50, 25), 0, 0, "B", 5, 12, 8, 4, 4, 0, 1, EntityType::BUSSTOP, Size::LARGE));

        // TrainStation
        entityConfigTable.emplace(std::make_pair(EntityType::TRAINSTATION, Size::SMALL),
                                  EntityConfig(Cost(1500, 600, 300, 200), 15, 0, "T", 10, 8, 5, 5, 5, 0, 4, EntityType::TRAINSTATION, Size::SMALL));
        entityConfigTable.emplace(std::make_pair(EntityType::TRAINSTATION, Size::MEDIUM),
                                  EntityConfig(Cost(3000, 1200, 600, 400), 30, 0, "T", 15, 15, 10, 7, 7, 0, 6, EntityType::TRAINSTATION, Size::MEDIUM));
        entityConfigTable.emplace(std::make_pair(EntityType::TRAINSTATION, Size::LARGE),
                                  EntityConfig(Cost(6000, 2400, 1200, 800), 50, 0, "T", 20, 25, 15, 10, 10, 0, 8, EntityType::TRAINSTATION, Size::LARGE));
    }
